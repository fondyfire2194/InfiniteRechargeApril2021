...
public class AutoModeRightOfCenter extends SequentialCommandGroup {
        /**
         * Creates a new Auto0.
         * 
        ...
        public AutoModeRightOfCenter(RevShooterSubsystem shooter, RevTurretSubsystem turret, RevTiltSubsystem tilt,
                ...
                super(new ResetEncoders(drive), new ResetGyro(drive),
                                new ParallelCommandGroup(new SetTiltOffset(tilt, tiltOffset),
                                                ...
                                                new PositionTiltToVision(tilt, limelight, tiltAngle + 2 + tiltOffset),
                                                new PositionTurretToVision(turret, limelight,
                                                                turretAngle + turretOffset - 3)),
                                ...
                                new ParallelCommandGroup(new MessageCommand("ShootIs3Started"),
                                                ...
                                                new ShootCells(shooter, tilt, turret, limelight, transport, null,
