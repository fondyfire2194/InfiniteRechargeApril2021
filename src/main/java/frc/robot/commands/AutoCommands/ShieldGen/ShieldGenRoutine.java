...
public class ShieldGenRoutine extends SequentialCommandGroup {
        /**
         * Creates a new Auto1.
         * 
        ...
        static double retractDistance1 = 3;

        public ShieldGenRoutine(RevShooterSubsystem shooter, RevTurretSubsystem turret, RevTiltSubsystem tilt,
