...
public class TrenchAuto1 extends ParallelRaceGroup {
  /** Creates a new Trench3BAllShootPlusPickup. */
  public TrenchAuto1(RevShooterSubsystem shooter, RevDrivetrain drive, RevTiltSubsystem tilt, RevTurretSubsystem turret,
    ...
    addCommands(
        ...
        new SetActive2ndShootData(ShootData.trench4Ball),
