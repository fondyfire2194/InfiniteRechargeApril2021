...
public class AutoMode6 extends SequentialCommandGroup {
  /**
   * Creates a new Auto6
   * 
   * Strt in front of trench move back pick up 2 and shoot
   */

  private final static int shootPosition = 2;
  ...
  public AutoMode6(RevShooterSubsystem shooter, RevTurretSubsystem turret, RevTiltSubsystem tilt,
