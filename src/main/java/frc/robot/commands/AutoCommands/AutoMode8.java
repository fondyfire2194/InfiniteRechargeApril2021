...
public class AutoMode8 extends SequentialCommandGroup {
  /**
   * Creates a new Auto8
   * 
   * Start in front of trench move back pick up 2 and shoot the move back under
   * control panel pick up 3 move forward and shoot
   */
  ...
  public AutoMode8(RevShooterSubsystem shooter, RevTurretSubsystem turret, RevTiltSubsystem tilt,
