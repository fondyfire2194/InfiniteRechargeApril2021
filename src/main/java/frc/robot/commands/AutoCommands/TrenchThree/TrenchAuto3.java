...
package frc.robot.commands.AutoCommands.TrenchThree;
...
import frc.robot.commands.AutoCommands.TrenchTwo.AutoMode3MnBallTrench;
...
public class TrenchAuto3 extends ParallelRaceGroup {
  /** Creates a new Trench3BAllShootPlusPickup. */
  public TrenchAuto3(RevShooterSubsystem shooter, RevDrivetrain drive, RevTiltSubsystem tilt, RevTurretSubsystem turret,
    ...
    addCommands(
        ...
        new SetActive2ndShootData(ShootData.trench6Ball),
