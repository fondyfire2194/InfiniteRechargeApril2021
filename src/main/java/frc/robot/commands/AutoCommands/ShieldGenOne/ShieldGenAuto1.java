...
public class ShieldGenAuto1 extends ParallelRaceGroup {
  /** Creates a new Trench3BAllShootPlusPickup. */
  public ShieldGenAuto1(RevShooterSubsystem shooter, RevDrivetrain drive, RevTiltSubsystem tilt, RevTurretSubsystem turret,
