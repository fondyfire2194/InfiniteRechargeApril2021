...
public class AutoMode3MnBallShield extends SequentialCommandGroup {
        /**
         * Creates a new Auto0.
         * 
        ...
        public AutoMode3MnBallShield(RevShooterSubsystem shooter, RevTurretSubsystem turret, RevTiltSubsystem tilt,
                ...
                super(
                                ...
                                new ParallelCommandGroup(new ResetEncoders(drive), new ResetGyro(drive),
                                                ...
                                                new ToShieldGenTarget(turret, tilt, shooter, limelight))
                                ...
                                new PickupMoveVelocity(drive, retractDistance1, 1.4)
                                ...
                                new ParallelCommandGroup(new MessageCommand("Shoot2Started"),
                                                new RunIntakeMotor(intake, .75), new UseVision(limelight, true),
