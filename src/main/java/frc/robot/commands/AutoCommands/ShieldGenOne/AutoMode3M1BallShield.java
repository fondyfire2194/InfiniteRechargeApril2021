...
public class AutoMode3M1BallShield extends SequentialCommandGroup {
        /**
         * Creates a new Auto0.
         * 
        ...
        public AutoMode3M1BallShield(RevShooterSubsystem shooter, RevTurretSubsystem turret, RevTiltSubsystem tilt,
                ...
                super(new ResetEncoders(drive), new ResetGyro(drive),
                                ...
                                new ParallelCommandGroup(new ToShieldGenTarget(turret, tilt, limelight))
