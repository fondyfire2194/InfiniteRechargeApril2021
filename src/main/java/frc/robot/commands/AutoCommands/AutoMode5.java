...
public class AutoMode5 extends SequentialCommandGroup {
  /**
   * Creates a new Auto5
   * 
   * Start right of power port move back and shoot
   */
  ...
  public AutoMode5(RevShooterSubsystem shooter, RevTurretSubsystem turret, RevTiltSubsystem tilt,
