...
public class AutoMode7 extends SequentialCommandGroup {
  /**
   * Creates a new Auto7
   * 
   * Start in front of trench move back pick up 2 and shoot move back pick up 1 aand shoot
   */
  ...
  public AutoMode7(RevShooterSubsystem shooter, RevTurretSubsystem turret, RevTiltSubsystem tilt,
