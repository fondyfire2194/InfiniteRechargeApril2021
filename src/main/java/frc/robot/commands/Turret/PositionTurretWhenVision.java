...
public class PositionTurretWhenVision extends CommandBase {
  ...
  public PositionTurretWhenVision(RevTurretSubsystem turret, LimeLight limelight) {
    // Use addRequirements() here to declare subsystem dependencies.
    m_turret = turret;
    m_limelight = limelight;
    m_originalTarget = m_turret.getAngle();
  ...
  public void execute() {
    ...
    endit = (m_limelight.getHorOnTarget() && m_limelight.getVertOnTarget() && Math.abs(m_turret.getSpeed()) < .1)
        && loopCtr > 4;
  }
