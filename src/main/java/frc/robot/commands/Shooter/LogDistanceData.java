...
public class LogDistanceData extends CommandBase {
   ...
   */
  public final String[] names = { "Step", "LeftMeters", "RightMeters", "CameraDistance", "BBHeight", "BBWidth",
      "RobotSpeed", "TiltAngle", "VertToTarget", "TurretAngle", "VertToTarget", "GyroYaw" };
  public static String[] units = { "Number", "Meters", "Meters", "Meters", "Pixels", "Pixels", "MPS", "Degrees",
  ...
  public void execute() {
    ...
    if (loopCtr >= 25) {
      ...
      m_shooter.simpleCSVLogger.writeData((double) step, m_drive.getLeftDistance(), m_drive.getRightDistance(),
          m_shooter.calculatedCameraDistance, m_limelight.getBoundingBoxHeight(), m_limelight.getBoundingBoxWidth(),
          m_drive.getLeftRate(), m_tilt.getAngle(), m_limelight.getdegVerticalToTarget(), m_turret.getAngle(),
          m_limelight.getdegRotationToTarget(), m_drive.getYaw());
    }
