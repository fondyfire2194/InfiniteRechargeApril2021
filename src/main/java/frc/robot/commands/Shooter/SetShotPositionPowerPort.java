...
public class SetShotPositionPowerPort extends SequentialCommandGroup {
        /**
         * Creates a new Auto0.
         * 
        ...
        public SetShotPositionPowerPort(RevShooterSubsystem shooter, RevTurretSubsystem turret, RevTiltSubsystem tilt,
                        CellTransportSubsystem transport, RearIntakeSubsystem intake, LimeLight limelight) {
                // Add your commands in the super() call, e.g.
                // super(new FooCommand(), new BarCommand());

                super(new ToPowerPortTarget(turret, tilt, shooter, limelight),
