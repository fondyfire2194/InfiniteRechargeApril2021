...
public interface ElevatorSubsystem extends Subsystem, AutoCloseable {
    final class ElevatorSimConstants {
        public static double kElevatorGearing = 10.0;
        public static double kCarriageMass = 4.0; // kg
        public static double kMinElevatorHeight = 0.0;
        public static double kMaxElevatorHeight = Units.inchesToMeters(50e50);
        public static DCMotor kElevatorGearbox = DCMotor.getVex775Pro(4);

        public static final double kElevatorDrumRadius = Units.inchesToMeters(2.0);

        public static ElevatorSim createSim() {

            ElevatorSim elevatorSim = new ElevatorSim(ElevatorSimConstants.kElevatorGearbox,
                    ElevatorSimConstants.kElevatorGearing, ElevatorSimConstants.kCarriageMass,
                    ElevatorSimConstants.kElevatorDrumRadius, ElevatorSimConstants.kMinElevatorHeight,
